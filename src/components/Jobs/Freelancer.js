...
const Freelancer = () => {
  ...
  return (
    <div className='jobs-text-container'>
      {language === "true" ? (
        <>
          <h3>🚀 Como desarrollador Freelancer me voy a encargar de cumplir tus objetivos al Maximo</h3>
        ...
        <>
          <h3>🚀 As a Freelancer developer I will take care of your goals to the maximum.</h3>
          <div className='jobs-text-freelancer-container'>
